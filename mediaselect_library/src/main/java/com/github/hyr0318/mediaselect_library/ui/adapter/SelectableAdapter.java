...
import com.github.hyr0318.mediaselect_library.event.Selectable;
...
public abstract class SelectableAdapter<VH extends RecyclerView.ViewHolder>
     ...
     */
    @Override
    public void toggleSelection(Photo photo,int type) {
    ...
    public void addSelectPhoto(List<Photo> photos) {
        if (null != photos) {
