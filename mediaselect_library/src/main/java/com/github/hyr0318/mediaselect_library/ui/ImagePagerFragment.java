...
import com.github.hyr0318.mediaselect_library.ui.adapter.PhotoPagerAdapter;
...
public class ImagePagerFragment extends Fragment {
    ...
    public static ImagePagerFragment newInstance(List<String> paths, int currentItem, int[]
        screenLocation, int thumbnailWidth, int thumbnailHeight) {
